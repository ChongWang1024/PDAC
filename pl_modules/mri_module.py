...
class MriModule(pl.LightningModule):
    ...
    def validation_epoch_end(self, val_logs):
        ...
        self.log("validation_loss", val_loss / tot_slice_examples)
        for metric, value in metrics.items():
            if metric == "nmse":
                self.log(f"val_metrics/{metric}", value / tot_examples, on_epoch=True)
            else:
                self.log(f"val_metrics/{metric}", value / tot_examples, prog_bar=True, on_epoch=True)
